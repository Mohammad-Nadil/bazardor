...
import { setLocation, setShowModal } from "../features/locationSlice";
...
const Modal = () => {
  ...
  const handleSubmit = (e) => {
    ...
    dispatch(setLocation({ division, district }));
  };
        ...
        >
          ...
          <div className="p-2 sm:p-6 bg-slate-50 flex gap-2 sm:gap-3 text-sm xs:text-base">
            ...
            <button
              ...
              className="flex-[1.5] py-2 sm:py-4 rounded-lg font-bold bg-primary text-white hover:bg-primary/90 transition-colors shadow-lg shadow-primary/20 flex items-center justify-center gap-2"
            >
